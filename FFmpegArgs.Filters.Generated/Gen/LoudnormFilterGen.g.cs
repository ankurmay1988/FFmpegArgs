namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal LoudnormFilterGen(AudioMap input) : base("loudnorm", input)
        {
            AddMapOut();
        }
    ...
    public enum LoudnormFilterGenPrint_format
    {
        ...
        /// json            1            ..F.A......
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("json")]
        json = 1,
        /// <summary>
        /// summary         2            ..F.A......
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("summary")]
        summary = 2
    }
