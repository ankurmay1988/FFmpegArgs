...
namespace FFmpegArgs.Codec.Encoders.Images
{
    ...
    /// </summary>
    public class Hevc_nvenc_CodecEncoder : BaseImageCodecEncoder
    {
        /// <summary>
        ///
        /// </summary>
        /// <param name="stream"></param>
        public Hevc_nvenc_CodecEncoder(ImageOutputAVStream stream) : base("hevc_nvenc", stream)
        {
        }
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder Preset(Hevc_nvenc_Preset preset)
            => this.SetOptionRange("-preset", (int)preset, 0, 18);

        /// <summary>
        /// Set the encoding tuning info (from 1 to 4) (default hq)
        /// </summary>
        public Hevc_nvenc_CodecEncoder Tune(Hevc_nvenc_Tune tune)
            => this.SetOptionRange("-tune", (int)tune, 1, 4);

        /// <summary>
        /// Set the encoding profile (from 0 to 2) (default main)
        /// </summary>
        public Hevc_nvenc_CodecEncoder Profile(Hevc_nvenc_Profile profile)
            => this.SetOptionRange("-profile", (int)profile, 0, 2);

        /// <summary>
        /// Set the encoding level restriction (from 0 to 186) (default auto)
        /// </summary>
        public Hevc_nvenc_CodecEncoder Level(Hevc_nvenc_Level level)
            => this.SetOptionRange("-level", (int)level, 0, 186);

        /// <summary>
        /// Set the encoding tier (from 0 to 1) (default main)
        /// </summary>
        public Hevc_nvenc_CodecEncoder Tier(Hevc_nvenc_Tier tier)
            => this.SetOptionRange("-tier", (int)tier, 0, 1);

        /// <summary>
        /// Override the preset rate-control (from -1 to INT_MAX) (default -1)
        /// </summary>
        public Hevc_nvenc_CodecEncoder RateControl(Hevc_nvenc_RateControl rateControl)
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder Delay(int delay)
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder ZeroLatency(bool zeroLatency)
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder NonRefP(bool nonRefP)
            => this.SetOption("-nonref_p", nonRefP.ToFFmpegFlag());

        /// <summary>
        /// Set 1 to minimize GOP-to-GOP rate fluctuations (default false)
        /// </summary>
        public Hevc_nvenc_CodecEncoder StrictGop(bool strictGop)
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder AQStrength(int aqStrength)
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder DpbSize(int dpb_size)
            => this.SetOptionRange("-dpb_size", dpb_size, 0, INT_MAX);

        /// <summary>
        /// Set the multipass encoding (from 0 to 2) (default disabled)
        /// </summary>
        public Hevc_nvenc_CodecEncoder MultiPass(Hevc_nvenc_MultiPass multiPass)
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder MaxSliceSize(int max_slice_size)
        ...
        /// </summary>
        public Hevc_nvenc_CodecEncoder ConstrainedEncoding(bool constrainedEncoding)
            => this.SetOption("-constrained-encoding", constrainedEncoding.ToFFmpegFlag());
    }

#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public enum Hevc_nvenc_Preset
    {
        @default = 0,
        ...
        ll = 7,
        /// <summary>low latency hq</summary>
        llhq = 8,
        /// <summary>low latency hp</summary>
        llhp = 9,
        /// <summary>lossless</summary>
        lossless = 10,
        /// <summary>lossless hp</summary>
        losslesshp = 11,
    ...
    public enum Hevc_nvenc_Profile
    {
        main = 0,
        main10 = 1,
        rext = 2,
    }
    public enum Hevc_nvenc_Level
    {
        auto = 0,
        Level_1 = 30,
        Level_1_0 = 30,
    ...
    public enum Hevc_nvenc_Tier
    {
        main = 0,
        high = 1,
    }
    public enum Hevc_nvenc_RateControl
    {
        ...
        cbr = 2,
        /// <summary>Constant bitrate low delay high quality mode</summary>
        cbr_ld_hq = 8388610,
        /// <summary>Constant bitrate high quality mode</summary>
        cbr_hq = 8388610,
        /// <summary>Variable bitrate high quality mode</summary>
        vbr_hq = 8388609,
    }
    public enum Hevc_nvenc_RgbMode
    {
    ...
    public enum Hevc_nvenc_BRefMode
    {
    ...
    public enum Hevc_nvenc_MultiPass
    {
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static partial class ImageEncoderExtensions
    {
        ...
        /// </summary>
        public static Hevc_nvenc_CodecEncoder Hevc_nvenc_Codec(this ImageOutputAVStream stream)
            => new Hevc_nvenc_CodecEncoder(stream);
        public static T Hevc_nvenc_Codec<T>(this T stream, Action<Hevc_nvenc_CodecEncoder> action) where T : ImageOutputAVStream
        {
            action.Invoke(stream.Hevc_nvenc_Codec());
            return stream;
        }
    }
}
