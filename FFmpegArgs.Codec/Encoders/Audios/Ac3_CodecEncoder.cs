...
namespace FFmpegArgs.Codec.Encoders.Audios
{
    ...
    /// ATSC A/52A (AC-3)
    /// </summary>
    public class Ac3_CodecEncoder : BaseAudioCodecEncoder
    {
        /// <summary>
        ///
        /// </summary>
        /// <param name="stream"></param>
        public Ac3_CodecEncoder(AudioOutputAVStream stream) : base("ac3", stream)
        {
        }
        ...
        /// </summary>
        public Ac3_CodecEncoder ChannelCoupling(int channel_coupling)
        ...
        /// </summary>
        public Ac3_CodecEncoder CplStartBand(int cpl_start_band)
            => this.SetOptionRange("-cpl_start_band", cpl_start_band, -1, 15);
    }

#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public enum Ac3_RoomType
    {
        /// <summary>Not Indicated (default)</summary>
        notindicated = 0,
    ...
    public enum Ac3_DsurMode
    {
        /// <summary>Not Indicated (default)</summary>
        notindicated = 0,
        /// <summary>Not Dolby Surround Encoded</summary>
        off = 1,
        /// <summary>Dolby Surround Encoded</summary>
        on = 2,
    }
    public enum Ac3_DmixMode
    {
        /// <summary>Not Indicated (default)</summary>
        notindicated = 0,
        /// <summary>Lt/Rt Downmix Preferred</summary>
        ltrt = 1,
        /// <summary>Lo/Ro Downmix Preferred</summary>
        loro = 2,
        /// <summary>Dolby Pro Logic II Downmix Preferred</summary>
        dplii = 3,
    }
    public enum Ac3_DsurexMode
    {
        /// <summary>Not Indicated (default)</summary>
        notindicated = 0,
        /// <summary>Not Dolby Surround EX Encoded</summary>
        off = 1,
        /// <summary>Dolby Surround EX Encoded</summary>
        on = 2,
        /// <summary>Dolby Pro Logic IIz-encoded</summary>
        dpliiz = 3,
    }
    public enum Ac3_DheadphoneMode
    {
        /// <summary>Not Indicated (default)</summary>
        notindicated = 0,
        /// <summary>Not Dolby Headphone Encoded</summary>
        off = 1,
        /// <summary>Dolby Headphone Encoded</summary>
        on = 2,
    }
    public enum Ac3_AdConvType
    {
        /// <summary>Standard (default)</summary>
        standard = 0,
        /// <summary>HDCD</summary>
        hdcd = 1,
    }
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    {
        /// <summary>
        /// ATSC A/52A (AC-3) encoder.
        /// </summary>
        public static Ac3_CodecEncoder Ac3_Codec(this AudioOutputAVStream stream)
            => new Ac3_CodecEncoder(stream);
        /// <summary>
        /// ATSC A/52A (AC-3) encoder.
        /// </summary>
        public static T Ac3_Codec<T>(this T stream, Action<Ac3_CodecEncoder> action) where T : AudioOutputAVStream
        {
            action.Invoke(stream.Ac3_Codec());
            return stream;
        }
    }
}
